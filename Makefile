...
spec/certora/Governor/%.cvl:
	$(CERTORA_RUN) \
	 ...
	 GovernorAlphaCertora:nwl=XVSCertora \
...
spec/certora/VBep20/%.cvl:
	$(CERTORA_RUN) \
	 ...
	 spec/certora/contracts/UnderlyingModelNonStandard.sol \
	--link \
	 VBep20ImmutableCertora:otherToken=NTokenCollateral \
	 ...
	 NTokenCollateral:comptroller=ComptrollerCertora \
...
spec/certora/VBep20Delegator/%.cvl:
	...
	--link \
	 ...
	 VBep20DelegatorCertora:otherToken=NTokenCollateral \
