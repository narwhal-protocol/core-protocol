const { makeInterestRateModel, getBorrowRate } = require("../Utils/Narwhal");
    ...
    describe(kind, () => {
      ...
      if (kind == "jump-rate") {
        ...
        it("handles failing to get exp of borrows / cash + borrows", async () => {
          await expect(
            getBorrowRate(model, 0, "0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF", 0),
