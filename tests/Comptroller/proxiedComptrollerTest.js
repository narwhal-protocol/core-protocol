...
const { makeNToken, makePriceOracle } = require("../Utils/Narwhal");
...
describe("Comptroller", function () {
  ...
  describe("delegating to comptroller", () => {
    ...
    beforeEach(async () => {
      ...
      vToken = await makeNToken({ comptroller: unitrollerAsComptroller });
    });
    ...
    describe("_setCollateralFactor", () => {
      ...
      it("fails if factor is too high", async () => {
        const vToken = await makeNToken({ supportMarket: true, comptroller: unitrollerAsComptroller });
    ...
    describe("_supportMarket", () => {
      ...
      it("can list two different markets", async () => {
        const vToken1 = await makeNToken({ comptroller: unitroller });
        const vToken2 = await makeNToken({ comptroller: unitroller });
