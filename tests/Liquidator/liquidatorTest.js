...
const { makeNToken, fastForward, setBalance, getBalances, adjustBalances, pretendBorrow } = require("../Utils/Narwhal");
...
describe("Liquidator", function () {
  ...
  beforeEach(async () => {
    ...
    vTokenCollateral = await makeNToken({ comptroller: vToken.comptroller });
    vBnb = await makeNToken({ kind: "vbnb", comptroller: vToken.comptroller });
