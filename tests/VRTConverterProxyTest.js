...
describe("VRTConverterProxy", () => {
  ...
  let vrtConversion,
    ...
    nwlToken,
    nwlTokenAddress;
  let nwlVestingProxy, nwlVestingProxyAddress, nwlVestingProxyAdmin; // eslint-disable-line @typescript-eslint/no-unused-vars
  ...
  beforeEach(async () => {
    ...
    nwlVestingProxyAddress = nwlVestingProxy._address;
    ...
    await send(vrtConverterProxy, "setXVSVesting", [nwlVestingProxyAddress]);
  ...
  describe("constructor", () => {
    it("sets admin to caller and addresses to 0", async () => {
      ...
      const nwlAddressResp = await call(vrtConverterProxy, "nwl");
      expect(nwlAddressResp).toEqual(nwlTokenAddress);

      const nwlVestingAddressResp = await call(vrtConverterProxy, "nwlVesting");
      expect(nwlVestingAddressResp).toEqual(nwlVestingProxyAddress);
