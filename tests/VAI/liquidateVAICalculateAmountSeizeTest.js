...
const { makeComptroller, makeNToken, setOraclePrice, setOraclePriceFromMantissa } = require("../Utils/Narwhal");
...
describe("Comptroller", () => {
  ...
  beforeEach(async () => {
    ...
    vTokenCollateral = await makeNToken({ comptroller: comptroller, underlyingPrice: 0 });
  });
