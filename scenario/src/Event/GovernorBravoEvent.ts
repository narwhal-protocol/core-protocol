  ...
  return [
    ...
    new Command<{ governor: GovernorBravo; newProposalThreshold: NumberV }>(
      `
        ...
        * "GovernorBravo <Governor> SetProposalThreshold <Nwl>" - Sets the proposal threshold of the GovernorBravo
    ...
    new Command<{
      ...
      `#### MergeABI
        * "GovernorBravo <Impl> MergeABI" - Merges the ABI, as if it was a become.
