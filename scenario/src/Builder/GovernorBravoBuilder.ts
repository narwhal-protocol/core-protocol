...
export async function buildGovernor(
  ...
  const fetchers = [
    ...
    >(
      ...
      * "GovernorBravo Deploy BravoDelegator name:<String> timelock:<Address> nwlVault:<Address> admin:<Address> implementation:<Address> votingPeriod:<Number> votingDelay:<Number> guardian:<Address>" - Deploys Narwhal Governor Bravo with a given parameters
    ...
    `,
      ...
      async (
        world,
        { name, timelock, nwlVault, admin, implementation, votingPeriod, votingDelay, proposalThreshold, guardian },
      ) => {
        return {
    ...
    >(
      ...
      * "GovernorBravoImmut Deploy BravoImmutable name:<String> timelock:<Address> nwlVault:<Address> admin:<Address> votingPeriod:<Number> votingDelay:<Number> guardian:<Address>" - Deploys Narwhal Governor Bravo Immutable with a given parameters
    ...
    `,
      ...
      async (world, { name, timelock, nwlVault, admin, votingPeriod, votingDelay, proposalThreshold, guardian }) => {
        return {
    ...
    new Fetcher<{ name: StringV }, GovernorBravoData>(
      ...
      * "Governor Deploy BravoDelegate name:<String>" - Deploys Narwhal Governor Bravo Delegate
    ...
    new Fetcher<{ name: StringV }, GovernorBravoData>(
      ...
      * "Governor Deploy BravoDelegateHarness name:<String>" - Deploys Narwhal Governor Bravo Delegate Harness
