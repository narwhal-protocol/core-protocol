...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$startRuleFunctions: { [id: string]: any } = {
    tests: peg$parsetests,
    step: peg$parsestep,
    macros: peg$parsemacros,
  };
  let peg$startRuleFunction: () => any = peg$parsetests;

  const peg$c0 = function (head: any, t: any) {
    return t;
  };
  const peg$c1 = function (head: any, tail: any) {
    return tail.reduce((acc, el) => addTopLevelEl(acc, el), addTopLevelEl({ macros: {}, tests: {} }, head));
  };
  const peg$c2 = function (values: any) {
    return values !== null ? values.tests : {};
  };
  const peg$c3 = function (values: any) {
    return values !== null ? values.macros : {};
  };
  const peg$c4 = "Test";
  const peg$c5 = peg$literalExpectation("Test", false);
  const peg$c6 = function (name: any, steps: any) {
    return { type: "test", test: getString(name), steps: steps };
  };
  const peg$c7 = "GasTest";
  const peg$c8 = peg$literalExpectation("GasTest", false);
  const peg$c9 = function (name: any, steps: any) {
    return { type: "test", test: getString(name), steps: ["Gas"].concat(steps) };
  };
  const peg$c10 = "Pending";
  const peg$c11 = peg$literalExpectation("Pending", false);
  const peg$c12 = function (name: any, steps: any) {
    return { type: "test", test: getString(name), steps: ["Pending"].concat(steps) };
  };
  const peg$c13 = "Only";
  const peg$c14 = peg$literalExpectation("Only", false);
  const peg$c15 = function (name: any, steps: any) {
    return { type: "test", test: getString(name), steps: ["Only"].concat(steps) };
  };
  const peg$c16 = "Skip";
  const peg$c17 = peg$literalExpectation("Skip", false);
  const peg$c18 = function (name: any, steps: any) {
    return { type: "test", test: getString(name), steps: ["Skip"].concat(steps) };
  };
  const peg$c19 = "Macro";
  const peg$c20 = peg$literalExpectation("Macro", false);
  const peg$c21 = function (name: any, args: any, steps: any) {
    return { type: "macro", name: getString(name), args: args || [], steps: steps };
  };
  const peg$c22 = function (head: any, tail: any) {
    return [head].concat(tail).filter(x => !!x);
  };
  const peg$c23 = function (args: any) {
  ...
  const peg$c28 = function (splat: any, arg: any, t: any) {
    return t;
  };
  const peg$c29 = function (splat: any, arg: any, def: any) {
    return { arg, def, splat };
  };
  const peg$c30 = function (tokens: any) {
    return tokens !== null ? tokens.flat() : [];
  };
  const peg$c31 = function (head: any, step: any) {
    return step;
  };
  const peg$c32 = function (steps: any) {
    return steps !== null ? steps : [];
  };
  const peg$c33 = function (step: any) {
    return step;
  };
  const peg$c34 = function () {
    return null;
  };
  const peg$c35 = function (val: any) {
    return val;
  };
  const peg$c36 = function (head: any, value: any) {
    return value;
  };
  const peg$c37 = function (head: any, tail: any) {
    return [head].concat(tail.flat(1));
  };
  const peg$c38 = function (inner: any) {
    return [inner];
  };
  const peg$c39 = function (inner: any) {
    return [["List"].concat((inner || []).flat())];
  };
  const peg$c40 = "--";
  ...
  const peg$c48 = function (token1: any, token2: any) {
    return { argName: token1, argValue: token2 };
  };
  const peg$c49 = /^[A-Za-z0-9_]/;
  const peg$c50 = peg$classExpectation([["A", "Z"], ["a", "z"], ["0", "9"], "_"], false, false);
  const peg$c51 = function (t: any) {
    return t.join("");
  };
  const peg$c52 = "0x";
  ...
  const peg$c56 = function (hex: any) {
    return ["Hex", hex.flat().flat().join("")];
  };
  const peg$c57 = "-";
  ...
  const peg$c67 = function (n: any) {
    return ["Exactly", n.flat().flat().join("")];
  };
  const peg$c68 = function (head: any, tail: any) {
  ...
  const peg$c93 = function (chars: any) {
  ...
  const peg$c116 = function (sequence: any) {
    return sequence;
  };
  ...
  function peg$parseexpr(): any {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$currPos;
      s1 = peg$parsebegin_narwhal();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseexpr();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseend_narwhal();
          if (s3 !== peg$FAILED) {
            s1 = peg$c38(s2);
            s0 = s1;
          } else {
  ...
  function peg$parsebegin_narwhal(): any {
    let s0, s1, s2, s3;
  ...
  function peg$parseend_narwhal(): any {
    let s0, s1, s2, s3;
  ...
  if (!Array.prototype.flat) {
    Object.defineProperty(Array.prototype, "flat", {
      configurable: true,
      value: function flat(_x) {
        const depth = isNaN(arguments[0]) ? 1 : Number(arguments[0]); // eslint-disable-line prefer-rest-params
  ...
  function expandEvent(macros, step) {
    ...
    if (macros[eventName]) {
      const expanded = expandMacro(macros[eventName], eventArgs);
  ...
  function getArgValues(eventArgs, macroArgs) {
    ...
    eventArgs.forEach(eventArg => {
      if (eventArg.argName) {
        ...
        if (usedNamedArg) {
          throw new Error(
            `Cannot use positional arg after named arg in macro invokation ${JSON.stringify(
              eventArgs,
            )} looking at ${eventArg.toString()}`,
          );
        }
  ...
  function addTopLevelEl(state, el) {
    ...
    switch (el.type) {
      case "macro":
        macro = { [el.name]: { args: el.args, steps: el.steps } };
