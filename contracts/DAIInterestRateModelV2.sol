...
/**
  * @title Narwhal's DAIInterestRateModel Contract (version 2)
  * @author Narwhal (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Narwhal Protocol whitepaper.
