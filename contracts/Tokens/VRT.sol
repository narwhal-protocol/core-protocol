...
contract VRT is Tokenlock {
    ...
    string public constant name = "Narwhal Reward Token";
    ...
    function transferFrom(address src, address dst, uint rawAmount) external validLock returns (bool) {
        ...
        if (spender != src && spenderAllowance != uint96(-1)) {
            uint96 newAllowance = sub96(spenderAllowance, amount, "VRT::transferFrom: transfer amount exceeds spender allowance");
