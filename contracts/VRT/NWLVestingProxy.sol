...
contract NWLVestingProxy is  NWLVestingAdminStorage {
    ...
    /**
      * @notice Emitted when pendingImplementation is accepted, which means NWLVesting implementation is updated
      */
    ...
    */
    ...
    constructor(address implementation_,
                address _nwlAddress) nonZeroAddress(implementation_) nonZeroAddress(_nwlAddress) public {
    ...
    */
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, "NWLVestingProxy::_setImplementation: admin only");
        require(implementation_ != address(0), "NWLVestingProxy::_setImplementation: invalid implementation address");
