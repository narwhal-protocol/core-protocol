...
contract NWLVaultAdminStorage {
    ...
    */
    ...
    /**
    * @notice Active brains of NWL Vault
    */
    address public implementation;

    /**
    * @notice Pending brains of NWL Vault
    */
    address public pendingNWLVaultImplementation;
}

contract NWLVaultStorageV1 is NWLVaultAdminStorage {
    /// @notice Guard variable for re-entrancy checks
    bool internal _notEntered;

    /// @notice The reward token store
    address public nwlStore;

    /// @notice The nwl token address
    address public nwlAddress;
...
contract NWLVaultStorage is NWLVaultStorageV1 {
