...
/**
 * @title Narwhal's NBNB Contract
 * @notice NToken which wraps BNB
 * @author Narwhal
 */
contract NBNB is NToken {
    /**
     * @notice Construct a new NBNB money market
    ...
    /**
     * @notice Send BNB to NBNB to mint
     */
