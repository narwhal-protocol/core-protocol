...
/**
 * @title Narwhal's NBep20Delegator Contract
 * @notice NTokens which wrap an EIP-20 underlying and delegate to an implementation
 * @author Narwhal
 */
contract NBep20Delegator is NTokenInterface, NBep20Interface, VDelegatorInterface {
    /**
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "NBep20Delegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"NBep20Delegator:fallback: cannot send value to fallback");
